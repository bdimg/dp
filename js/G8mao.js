					...
					return o(e, [{
						...
						value: function() {
							this.container.innerHTML = (0, c.default)({
								...
								this.container.querySelector(".yzmplayer-setting-loop"), this.land = this.container.querySelector(".yzmplayer-setting-land"), this.loopToggle = this.container.querySelector(
									".yzmplayer-setting-loop .yzmplayer-toggle-setting-input"), this.landToggle = this.container.querySelector(".yzmplayer-setting-land .yzmplayer-toggle-setting-input"), this.showDanmaku = this.container.querySelector(
								...
								this.container.querySelector(".yzmplayer-controller"), this.commentInput = this.container.querySelector(
									...
									".yzmplayer-full-icon"), this.hzhFullButton = this.container.querySelector(
									".yzmplayer-full-hzh-icon"),this.webFullButton = this.container.querySelector(".yzmplayer-full-in-icon"),
			...
			var a = function() {
				...
				r = function() {
					...
					return a(e, [{
                        ...
                        //强制横屏，没多做测试，ios不行
                       this.player.setting.land && screen.orientation.lock('landscape').catch(e => alert('强制横屏错误，请关闭设置，'+e.message));
                        break;
								case "web":
...
n = Math.max(n, 0), n = Math.min(n, 1),	
						...
						value: function() {
							...
							this.player.template.hzhFullButton.addEventListener("click", function() {
                               if (!document.pictureInPictureElement) {e.player.video.requestPictureInPicture()} 
					...
					function e(t) {
						...
						i(this, e), this.player = t, this.player.template.mask.addEventListener("click", function() {
							...
							.loop.addEventListener("click", function() {
                                ...
                                n.player.template.landToggle.checked = !n.player.template.landToggle.checked,
                                n.player.template.landToggle.checked ? n.land = !0 : n.land = !1,
                                n.player.user.set("land", n.land ? 1 : 0),
                                n.hide()
				...
				o = function() {
					...
					return a(e, [{
						...
						value: function() {
							...
							this.template.infoVersion.innerHTML = "3.5.8", 
